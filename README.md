...
**Git:**
```bash
git clone --depth=1 https://github.com/mk00pl/twint.git
cd twint
...
```bash
pip3 install --user --upgrade git+https://github.com/mk00pl/twint.git@origin/master#egg=twint
```

**Pipenv**:
```bash
pipenv install git+https://github.com/mk00pl/twint.git#egg=twint
```
...
- `twint -s "Elon Musk" --verified` - Display Tweets by verified users that Tweeted about Elon Musk.
...
`1496221077265170435 2022-02-22 21:31:17 +0200 <elonmusk> @CyberpunkGame Great game`
